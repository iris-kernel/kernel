...
bin/kernel.elf: linker.ld bin/main.o bin/entry.o bin/physical.o bin/dtb.o
	$(TC)-ld -T linker.ld -nostdlib bin/main.o bin/entry.o bin/physical.o bin/dtb.o -o bin/kernel.elf
...
qemu: binary
	qemu-system-riscv64 -machine virt -cpu rv64 -kernel bin/kernel.bin -m 512M -nographic
